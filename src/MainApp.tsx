      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-lg leading-tight">OrganizaAI</h1>
                              ...
                              <div className="mt-3 space-y-1">
                                {d.start && (
                                  <p className="text-[10px] text-gray-500">
                                    <span className="font-semibold">Início:</span> {new Date(d.start).toLocaleDateString('pt-BR', { timeZone: 'UTC' })}
                                  </p>
                                )}
                                {d.date && (
                                  <p className="text-[10px] text-gray-500">
                                    <span className="font-semibold">Fim:</span> {new Date(d.date).toLocaleDateString('pt-BR', { timeZone: 'UTC' })}
                                  </p>
                                )}
                              </div>
                            </div>
